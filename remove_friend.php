...
if(isset($_POST['to_user_id']))
{
	...
	mysqli_query($con, "DELETE FROM `friends` WHERE (to_user_id='$to_user_id' AND form_user_id = '$current_user_id') OR (to_user_id='$current_user_id' AND form_user_id = '$to_user_id')");
}
